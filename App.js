...
function showInstallGuide(){
    ...
    alert(
`📲 راهنمای نصب وب‌اپ بازی‌های آموزشی

🔹 اندروید:
در مرورگر Chrome وارد سایت بازی‌های آموزشی حیدرزاده شوید.

سپس از منوی ⋮ گزینه «Install app» یا «نصب برنامه» را انتخاب کنید.

🔹 پس از نصب:
آیکون «حیدرزاده» روی صفحه اصلی گوشی قرار می‌گیرد.

از این به بعد کافی است روی آیکون حیدرزاده بزنید تا با یک کلیک وارد صفحه بازی‌ها شوید و از بازی و یادگیری لذت ببرید. 🎮🌱

✨ با نصب وب‌اپ، همیشه با یک کلیک به بازی‌های آموزشی دسترسی خواهید داشت.`
    );
